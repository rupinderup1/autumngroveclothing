...
import { faAppleWhole, faCartArrowDown, faCartFlatbedSuitcase } from '@fortawesome/free-solid-svg-icons';
...
function MyDrawer() {
  ...
  return (
    ...
    <Drawer.Navigator 
      ...
      screenOptions={{
        headerShown: true, 
        headerRight: () => (<TouchableOpacity style={{width: 44}} onPress={() => navigation.navigate('CartList')}>
